...
class _VisualizarContratoPageState
  ...
  Future<void> abrirAssinatura() async {
    ...
    try {
      ...
      if(contratoUrl.toString().isEmpty){
        ...
        ScaffoldMessenger.of(context)
          ...
          const SnackBar(
            ...
            Text(
              ...
              'Contrato ainda não possui PDF liberado.',
        ...
        builder:
          ...
          return ListView(
            ...
            children:[
              ...
              contratoPdfUrl.toString().isEmpty &&
