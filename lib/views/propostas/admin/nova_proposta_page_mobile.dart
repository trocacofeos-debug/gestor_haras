...
class NovaPropostaPageMobile extends StatefulWidget {
  const NovaPropostaPageMobile({super.key});

  @override
  State<NovaPropostaPageMobile> createState() =>
      _NovaPropostaPageMobileState();
}

class _NovaPropostaPageMobileState
    extends State<NovaPropostaPageMobile> {
  final _formKey =
      GlobalKey<FormState>();
