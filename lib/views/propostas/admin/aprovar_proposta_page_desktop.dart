...
class AprovarPropostaPageDesktop extends StatefulWidget {

  final String propostaId;

  const AprovarPropostaPageDesktop({
    super.key,
  ...
  @override
  State<AprovarPropostaPageDesktop> createState() =>
      _AprovarPropostaPageDesktopState();
...
class _AprovarPropostaPageDesktopState
    extends State<AprovarPropostaPageDesktop> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text("Analisar Proposta"),
        centerTitle: true,
      ),
      body: SingleChildScrollView(
        ...
        child: Row(
          ...
          children: [
            ...
            // Coluna esquerda: cliente + documentos
            Expanded(
              flex: 2,
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
