...
class DetalhesPropostaPageDesktop extends StatelessWidget {
  ...
  const DetalhesPropostaPageDesktop({
            ...
            child: StreamBuilder<DocumentSnapshot>(
              ...
              builder: (context, snapshot) {
                ...
                if (!snapshot.hasData || !snapshot.data!.exists) {
                  return const Center(
                    child: Text("Proposta não encontrada"),
                  );
                }
                ...
                final contratoAssinadoUrl = dados["contratoAssinadoUrl"] ??
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            _documentoCard(
                              ...
                              url: proposta.comprovanteUrl,
                              icon: Icons.home,
                            ),
                            _documentoCard(
                              context: context,
                              titulo: "Selfie com documento",
                              url: proposta.selfieDocumentoUrl,
                              icon: Icons.face,
                            ),
                            _documentoCard(
                              context: context,
                            ...
                            if (proposta.status == "documentos_enviados" ||
                            ...
                            if (proposta.status == "contrato_liberado" ||
