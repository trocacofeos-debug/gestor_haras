...
class DetalhesPropostaPageDesktop extends StatelessWidget {
  final String propostaId;

  const DetalhesPropostaPageDesktop({super.key, required this.propostaId});
      ...
      child: Row(
        children: [
          ...
          Container(
            ...
            child: Icon(Icons.description_rounded, color: primaria, size: 30),
          ),
  ...
  Widget _documentoCard({
    ...
    final enviado = url != null && url.trim().isNotEmpty;

    final corIcone = titulo.contains("Assinado")
        ? Colors.green
    ...
    return Container(
      ...
      child: Row(
        children: [
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  ...
                  style: TextStyle(
                    color: enviado ? Colors.green : Colors.grey,
          ...
          if (enviado)
            IconButton(
              icon: Icon(Icons.visibility, color: primaria),

              tooltip: "Visualizar documento",

              onPressed: () {
                _abrirDocumento(context, url);
              },
            )
          else
            ...
            child: StreamBuilder<DocumentSnapshot>(
              ...
              builder: (context, snapshot) {
                ...
                if (!snapshot.hasData || !snapshot.data!.exists) {
                  return const Center(child: Text("Proposta não encontrada"));
                }

                final dados = snapshot.data!.data() as Map<String, dynamic>;

                final proposta = PropostaModel.fromMap(
                  snapshot.data!.id,
                  dados,
                );
                  ...
                  child: Center(
                    child: ConstrainedBox(
                      ...
                      child: Row(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          // Coluna esquerda: cliente + status
                          SizedBox(
                            width: 360,
                            child: Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Container(
                                    ...
                                    child: Text(
                                      _tituloStatus(proposta.status),
                                      style: TextStyle(
                                        color: _corStatus(proposta.status),
                                        fontWeight: FontWeight.bold,
                                      ),
                                    ),
                                  ),
                          ...
                          // Coluna direita: documentos + ações
                          Expanded(
                            child: Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                _titulo("Contrato", Icons.folder_copy_rounded),
                                const SizedBox(height: 5),
                                _documentoCard(
                                  context: context,
                                  titulo: "Contrato PDF",
                                  url: proposta.contratoVisualizacao,
                                  icon: Icons.picture_as_pdf,
                                ),
                                _documentoCard(
                                  context: context,
                                  titulo: "Contrato Assinado PDF",
                                  url: contratoAssinadoUrl.toString(),
                                  icon: Icons.verified,
                                ),
                                  ...
                                  SizedBox(
                                    ...
                                    child: ElevatedButton.icon(
                                      ...
                                      onPressed: () async {
                                        ...
                                        try {
                                          await PropostaService().gerarContrato(
                                            proposta.id,
                                          );
                                ...
                                if (proposta.status == "aguardando_assinatura")
                                  Container(
