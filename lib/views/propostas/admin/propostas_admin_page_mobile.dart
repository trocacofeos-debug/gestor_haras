...
class PropostasAdminPageMobile extends StatefulWidget {
  ...
  @override
  State<PropostasAdminPageMobile> createState() =>
      _PropostasAdminPageMobileState();

}



class _PropostasAdminPageMobileState
    extends State<PropostasAdminPageMobile> {
    ...
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton.extended(
        ...
        onPressed: () {
          Navigator.push(
            context,
            MaterialPageRoute(builder: (_) => const NovaPropostaPage()),
          );
        },
      ),
        ...
        builder: (context, snapshot) {
          ...
          return ListView.builder(
            ...
            itemBuilder: (context, index) {
              return _cardProposta(context, docs[index]);
            },
          );
        },
      ),
