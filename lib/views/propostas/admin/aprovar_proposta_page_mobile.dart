...
class AprovarPropostaPageMobile extends StatefulWidget {

  final String propostaId;

  const AprovarPropostaPageMobile({
    super.key,
  ...
  @override
  State<AprovarPropostaPageMobile> createState() =>
      _AprovarPropostaPageMobileState();
...
class _AprovarPropostaPageMobileState
    extends State<AprovarPropostaPageMobile> {
