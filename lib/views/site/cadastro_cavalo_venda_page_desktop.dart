...
class CadastroCavaloVendaPageMobile extends StatefulWidget {
  final CavaloVendaModel? cavaloParaEditar;

  const CadastroCavaloVendaPageMobile({super.key, this.cavaloParaEditar});

  @override
  State<CadastroCavaloVendaPageMobile> createState() =>
      _CadastroCavaloVendaPageMobileState();
}

class _CadastroCavaloVendaPageMobileState extends State<CadastroCavaloVendaPageMobile> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(editando ? 'Editar Cavalo à Venda' : 'Novo Cavalo à Venda'),
      ),
      body: Form(
        key: _formKey,
        child: ListView(
