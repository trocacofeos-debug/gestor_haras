...
class NoticiasPageMobile extends StatefulWidget {
  const NoticiasPageMobile({super.key});

  @override
  State<NoticiasPageMobile> createState() => _NoticiasPageMobileState();
}

class _NoticiasPageMobileState extends State<NoticiasPageMobile> {
