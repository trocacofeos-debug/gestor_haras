              ...
              builder: (context, snapshot) {
                ...
                return ListView(
                  ...
                  children: [
                    ...
                    _titulo('Dados do Animal', Icons.info_outline_rounded),
                    ...
                    _titulo('Proprietário', Icons.person_outline_rounded),
                    ...
                    if (cavalo.observacoes.isNotEmpty) ...[
                      ...
                      _campo('Notas', cavalo.observacoes, Icons.notes_rounded),
                    ],
