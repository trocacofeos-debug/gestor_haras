...
// =====================================================
// FuncionariosListPageMobile
// =====================================================
//
// Versão mobile: lista de cards, igual já funcionava
// antes de separar Desktop/Mobile.

class FuncionariosListPageMobile extends StatefulWidget {
  const FuncionariosListPageMobile({super.key});

  @override
  State<FuncionariosListPageMobile> createState() =>
      _FuncionariosListPageMobileState();
}

class _FuncionariosListPageMobileState
    extends State<FuncionariosListPageMobile> {
  String busca = '';
