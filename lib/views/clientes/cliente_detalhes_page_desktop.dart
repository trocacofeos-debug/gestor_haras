...
class ClienteDetalhesPageDesktop extends StatelessWidget {
              ...
              child: Center(
                child: ConstrainedBox(
                  ...
                  child: Row(
                    ...
                    children: [
                      // Coluna esquerda: perfil + situação financeira
                      SizedBox(
                        width: 380,
                      ...
                      // Coluna direita: dados completos + módulos
                      Expanded(
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
      ...
      child: Row(
        children: [
          ...
          Container(
            ...
            child: Icon(Icons.person_rounded, color: primaria, size: 30),
          ),
          ...
          InkWell(
            ...
            child: Container(
              ...
              child: Icon(Icons.edit_rounded, color: primaria),
            ),
          ),
        ],
      ),
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          Text(
            cliente.nomeExibicao.isEmpty ? "Cliente" : cliente.nomeExibicao,
            ...
            child: Row(
              ...
              children: [
                Icon(
                  ...
                  color: cliente.ativo ? Colors.greenAccent : Colors.redAccent,
                ),
  ...
  Widget _resumo() {
    return Container(
      ...
      child: Row(
        children: [
          Expanded(
            child: _miniInfo(Icons.badge_rounded, "Documento", cliente.cpfCnpj),
          ),
  ...
  Widget _divisor() {
    return Container(width: 1, height: 55, color: Colors.grey.shade300);
  }

  Widget _miniInfo(IconData icon, String titulo, String valor) {
    return Column(
      children: [
        Icon(icon, color: primaria, size: 26),
