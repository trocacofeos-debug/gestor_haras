...
class _ClientesPageDesktopState extends State<ClientesPageDesktop> {
      ...
      child: Row(
        children: [
          ...
          Container(
            ...
            decoration: BoxDecoration(
              color: corPrimaria.withOpacity(.10),
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  ...
                  style: TextStyle(color: corSecundario, fontSize: 13),
                ),
              ],
            ),
          ),
          ...
          IconButton(
            ...
            icon: const Icon(Icons.refresh_rounded, color: corPrimaria),
          ),
        ],
      ),
    );
  ...
  Widget _cardsResumo(List<ClienteModel> clientes) {
    final ativos = clientes.where((c) => c.ativo).length;

    final inativos = clientes.length - ativos;
    ...
    return Padding(
      ...
      child: TextField(
        ...
        decoration: InputDecoration(
          ...
          prefixIcon: const Icon(Icons.search, color: corPrimaria),
