...
class ClienteModuloPageMobile extends StatefulWidget {
  ...
  @override
  State<ClienteModuloPageMobile> createState() =>
      _ClienteModuloPageMobileState();
...
class _ClienteModuloPageMobileState
    extends State<ClienteModuloPageMobile> {
  ...
  final PropostaService _propostaService =
      PropostaService();
  ...
  String inicialCliente(){
    ...
    final nome =
        widget.cliente.nomeExibicao.trim();
      ...
      builder:(context,snapshot){
        ...
        return Column(
          ...
          children: [
            ...
            ...dividasParaAcompanhar.map(

              (id) => _agregadorPagamentos(id),
  ...
  Widget _parcelasDaDivida(
    ...
    return StreamBuilder<QuerySnapshot<Map<String,dynamic>>>(
      ...
      _dividaService.parcelas(dividaId),
  ...
  Future<void> _pagarParcela(
    ...
    try {
      ...
      await _dividaService.pagarParcela(
  ...
  Future<void> _confirmarQuitarDivida(
    ...
    try {
      ...
      await _dividaService.quitarDivida(
  ...
  Widget _moduloPropostas(){
    ...
    return StreamBuilder<QuerySnapshot<Map<String,dynamic>>>(
      ...
      _propostaService.listarPorCliente(
        widget.cliente.id,
      ),
                      ...
                      Expanded(
                        ...
                        child: Text(
                          ...
                          (data["observacoes"] != null &&
                                  data["observacoes"].toString().trim().isNotEmpty)
                              ? data["observacoes"]
                              : "Proposta",
  ...
  Future<void> _abrirFormularioProposta() async {
    ...
    final dados = {
      ...
      converterValor(valor.text),



      "parcelas":

      int.tryParse(parcelas.text.trim()) ?? 1,
