...
class _LoginPageMobileState extends State<LoginPageMobile> {
  ...
  Future<void> logar() async {
    if (email.text.trim().isEmpty || senha.text.trim().isEmpty) {
      _mensagem("Preencha email e senha", Colors.orange);
    ...
    try {
      ...
      String texto = "Email ou senha incorretos";
      ...
      switch (e.code) {
        ...
        case "user-disabled":
          texto = "Usuário desativado";

          break;

        case "network-request-failed":
          texto = "Sem conexão com internet";

          break;

        case "too-many-requests":
          texto = "Muitas tentativas. Aguarde.";

          break;
      }

      if (mounted) {
        _mensagem(texto, Colors.red);
      }
    } catch (e) {
      if (mounted) {
        _mensagem("Erro ao acessar sistema", Colors.red);
      }
    }
  ...
  InputDecoration _campo(String titulo, IconData icone) {
    return InputDecoration(
      ...
      prefixIcon: Icon(icone, color: primaria),

      suffixIcon: titulo == "Senha"
          ? IconButton(
              icon: Icon(
                ocultarSenha
              ...
              child: Column(
                ...
                children: [
                  ...
                  TextField(
                    ...
                    decoration: _campo("Email", Icons.email_outlined),
                  ),
                  ...
                  TextField(
                    ...
                    decoration: _campo("Senha", Icons.lock_outline),
                  ),
