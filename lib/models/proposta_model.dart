...
class PropostaModel {
  ...
  factory PropostaModel.fromMap(
    ...
    return PropostaModel(
      ...
      selfieDocumentoUrl: map['selfieDocumentoUrl'],

      contratoPdfUrl: map['contratoPdfUrl'],
      assinaturaUrl: map['assinaturaUrl'],

      status: map['status'] ?? 'aguardando_documentos',

      documentosEnviados:
          map['documentosEnviados'] ?? false,

      contratoLiberado:
          map['contratoLiberado'] ?? false,
  ...
  Map<String, dynamic> toMap() {
    return {
      ...
      'selfieDocumentoUrl': selfieDocumentoUrl,
  ...
  PropostaModel copyWith({
    ...
    return PropostaModel(
      ...
      contratoPdfUrl:
          contratoPdfUrl ?? this.contratoPdfUrl,
